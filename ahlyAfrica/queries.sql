...
SELECT "Extract"."PlayerID=" AS "PlayerID=",
  (CASE WHEN ((AVG((CASE WHEN ("Extract"."EventID=" IN (3, 6, 11, 12, 13, 15, 16, 17, 18, 19, 29, 32, 33, 34, 35, 36, 37, 38)) THEN "Extract"."X=" ELSE null::int END)) < -11) AND (MEDIAN((CASE WHEN ("Extract"."EventID=" IN (3, 6, 11, 12, 13, 15, 16, 17, 18, 19, 29, 32, 33, 34, 35, 36, 37, 38)) THEN "Extract"."X=" ELSE null::int END)) > -40) AND (MEDIAN((CASE WHEN ("Extract"."EventID=" IN (3, 6, 11, 12, 13, 15, 16, 17, 18, 19, 29, 32, 33, 34, 35, 36, 37, 38)) THEN ABS("Extract"."Y=") ELSE null::int END)) < 25)) THEN 'Centerback' WHEN ((MEDIAN((CASE WHEN ("Extract"."EventID=" IN (3, 6, 11, 12, 13, 15, 16, 17, 18, 19, 29, 32, 33, 34, 35, 36, 37, 38)) THEN ABS("Extract"."Y=") ELSE null::int END)) > 24) AND (MEDIAN((CASE WHEN ("Extract"."EventID=" IN (3, 6, 11, 12, 13, 15, 16, 17, 18, 19, 29, 32, 33, 34, 35, 36, 37, 38)) THEN "Extract"."X=" ELSE null::int END)) < 7)) THEN 'Fullback' WHEN (MEDIAN((CASE WHEN ("Extract"."EventID=" IN (3, 6, 11, 12, 13, 15, 16, 17, 18, 19, 29, 32, 33, 34, 35, 36, 37, 38)) THEN "Extract"."X=" ELSE null::int END)) < -40) THEN 'Keeper' WHEN ((MEDIAN((CASE WHEN ("Extract"."EventID=" IN (3, 6, 11, 12, 13, 15, 16, 17, 18, 19, 29, 32, 33, 34, 35, 36, 37, 38)) THEN "Extract"."X=" ELSE null::int END)) > -12) AND (MEDIAN((CASE WHEN ("Extract"."EventID=" IN (3, 6, 11, 12, 13, 15, 16, 17, 18, 19, 29, 32, 33, 34, 35, 36, 37, 38)) THEN "Extract"."X=" ELSE null::int END)) < 0) AND (MEDIAN((CASE WHEN ("Extract"."EventID=" IN (3, 6, 11, 12, 13, 15, 16, 17, 18, 19, 29, 32, 33, 34, 35, 36, 37, 38)) THEN ABS("Extract"."Y=") ELSE null::int END)) < 25)) THEN 'DefensiveMid' WHEN ((MEDIAN((CASE WHEN ("Extract"."EventID=" IN (3, 6, 11, 12, 13, 15, 16, 17, 18, 19, 29, 32, 33, 34, 35, 36, 37, 38)) THEN ABS("Extract"."Y=") ELSE null::int END)) < 25) AND (MEDIAN((CASE WHEN ("Extract"."EventID=" IN (3, 6, 11, 12, 13, 15, 16, 17, 18, 19, 29, 32, 33, 34, 35, 36, 37, 38)) THEN "Extract"."X=" ELSE null::int END)) > -1) AND (MEDIAN((CASE WHEN ("Extract"."EventID=" IN (3, 6, 11, 12, 13, 15, 16, 17, 18, 19, 29, 32, 33, 34, 35, 36, 37, 38)) THEN "Extract"."X=" ELSE null::int END)) < 6)) THEN 'Centermid' WHEN ((MEDIAN((CASE WHEN ("Extract"."EventID=" IN (3, 6, 11, 12, 13, 15, 16, 17, 18, 19, 29, 32, 33, 34, 35, 36, 37, 38)) THEN "Extract"."X=" ELSE null::int END)) > 14) AND (MEDIAN((CASE WHEN ("Extract"."EventID=" IN (3, 6, 11, 12, 13, 15, 16, 17, 18, 19, 29, 32, 33, 34, 35, 36, 37, 38)) THEN ABS("Extract"."Y=") ELSE null::int END)) < 23)) THEN 'Striker' WHEN ((MEDIAN((CASE WHEN ("Extract"."EventID=" IN (3, 6, 11, 12, 13, 15, 16, 17, 18, 19, 29, 32, 33, 34, 35, 36, 37, 38)) THEN "Extract"."X=" ELSE null::int END)) >= 6) AND (MEDIAN((CASE WHEN ("Extract"."EventID=" IN (3, 6, 11, 12, 13, 15, 16, 17, 18, 19, 29, 32, 33, 34, 35, 36, 37, 38)) THEN ABS("Extract"."Y=") ELSE null::int END)) < 23)) THEN 'AttackingMid' WHEN ((MEDIAN((CASE WHEN ("Extract"."EventID=" IN (3, 6, 11, 12, 13, 15, 16, 17, 18, 19, 29, 32, 33, 34, 35, 36, 37, 38)) THEN ABS("Extract"."Y=") ELSE null::int END)) > 22) AND (MEDIAN((CASE WHEN ("Extract"."EventID=" IN (3, 6, 11, 12, 13, 15, 16, 17, 18, 19, 29, 32, 33, 34, 35, 36, 37, 38)) THEN "Extract"."X=" ELSE null::int END)) > 6)) THEN 'Winger' ELSE null::text END) AS "usr:Calculation_2284169459433848840:nk"
FROM "Extract"."Extract" "Extract"
GROUP BY 1
...
SELECT "t1"."PlayerID=" AS "PlayerID=",
  ...
  MEDIAN((CASE WHEN "t1"."$temp7_cse" THEN ABS("t1"."Y=") ELSE null::int END)) AS "TEMP(Median X for Position (copy))(4165715327)(0)",
...
GROUP BY 1
HAVING (((CASE WHEN ((AVG((CASE WHEN "t1"."$temp11_cse" THEN "t1"."X=" ELSE null::int END)) < -11) AND (MEDIAN((CASE WHEN "t1"."$temp11_cse" THEN "t1"."X=" ELSE null::int END)) > -40) AND (MEDIAN((CASE WHEN "t1"."$temp11_cse" THEN ABS("t1"."Y=") ELSE null::int END)) < 25)) THEN 'Centerback' WHEN ((MEDIAN((CASE WHEN "t1"."$temp11_cse" THEN ABS("t1"."Y=") ELSE null::int END)) > 24) AND (MEDIAN((CASE WHEN "t1"."$temp11_cse" THEN "t1"."X=" ELSE null::int END)) < 7)) THEN 'Fullback' WHEN (MEDIAN((CASE WHEN "t1"."$temp11_cse" THEN "t1"."X=" ELSE null::int END)) < -40) THEN 'Keeper' WHEN ((MEDIAN((CASE WHEN "t1"."$temp11_cse" THEN "t1"."X=" ELSE null::int END)) > -12) AND (MEDIAN((CASE WHEN "t1"."$temp11_cse" THEN "t1"."X=" ELSE null::int END)) < 0) AND (MEDIAN((CASE WHEN "t1"."$temp11_cse" THEN ABS("t1"."Y=") ELSE null::int END)) < 25)) THEN 'DefensiveMid' WHEN ((MEDIAN((CASE WHEN "t1"."$temp11_cse" THEN ABS("t1"."Y=") ELSE null::int END)) < 25) AND (MEDIAN((CASE WHEN "t1"."$temp11_cse" THEN "t1"."X=" ELSE null::int END)) > -1) AND (MEDIAN((CASE WHEN "t1"."$temp11_cse" THEN "t1"."X=" ELSE null::int END)) < 6)) THEN 'Centermid' WHEN ((MEDIAN((CASE WHEN "t1"."$temp11_cse" THEN "t1"."X=" ELSE null::int END)) > 14) AND (MEDIAN((CASE WHEN "t1"."$temp11_cse" THEN ABS("t1"."Y=") ELSE null::int END)) < 23)) THEN 'Striker' WHEN ((MEDIAN((CASE WHEN "t1"."$temp11_cse" THEN "t1"."X=" ELSE null::int END)) >= 6) AND (MEDIAN((CASE WHEN "t1"."$temp11_cse" THEN ABS("t1"."Y=") ELSE null::int END)) < 23)) THEN 'AttackingMid' WHEN ((MEDIAN((CASE WHEN "t1"."$temp11_cse" THEN ABS("t1"."Y=") ELSE null::int END)) > 22) AND (MEDIAN((CASE WHEN "t1"."$temp11_cse" THEN "t1"."X=" ELSE null::int END)) > 6)) THEN 'Winger' ELSE null::text END) = 'Fullback') AND ((SUM("t1"."$temp7_cse") <= 707) AND (SUM("t1"."$temp8_cse") <= 154) AND (SUM("t1"."$temp9_cse") >= 0) AND (SUM("t1"."$temp9_cse") <= 2415) AND (SUM("t1"."$temp10_cse") >= 0) AND (SUM("t1"."$temp10_cse") <= 117) AND (SUM(("t1"."$temp10_cse" + "t1"."$temp9_cse")) >= 0) AND (SUM(("t1"."$temp10_cse" + "t1"."$temp9_cse")) <= 2418) AND ((CAST(SUM("t1"."Minutes") AS DOUBLE PRECISION OR NULL) / NULLIF(90,0)) >= '14.999999999999851'::double precision) AND ((CAST(SUM("t1"."Minutes") AS DOUBLE PRECISION OR NULL) / NULLIF(90,0)) <= '30.000000000000298'::double precision)))
...
SELECT "Extract"."PlayerID=" AS "PlayerID=",
  ...
  SUM((CASE ("Extract"."EventID=" = 27) WHEN TRUE THEN "Extract"."xA" WHEN FALSE THEN 0 ELSE NULL END)) AS "TEMP(Calculation_9851124000635091)(1801517227)(0)",
  SUM((CASE ("Extract"."EventID=" = 26) WHEN TRUE THEN "Extract"."xA" WHEN FALSE THEN 0 ELSE NULL END)) AS "TEMP(Corners xA (copy))(2964885437)(0)",
  MEDIAN((CASE WHEN ("Extract"."EventID=" IN (3, 6, 11, 12, 13, 15, 16, 17, 18, 19, 29, 32, 33, 34, 35, 36, 37, 38)) THEN ABS("Extract"."Y=") ELSE null::int END)) AS "TEMP(Median X for Position (copy))(4165715327)(0)",
...
SELECT "Extract"."PlayerID=" AS "PlayerID=",
  ...
  SUM((CASE WHEN (("Extract"."Is CP" = 1) AND (TABLEAU.SQRT((TABLEAU.POWER(CAST(("Extract"."EndXpass" - 60) AS DOUBLE PRECISION OR NULL), 2) + TABLEAU.POWER(CAST("Extract"."EndYPass" AS DOUBLE PRECISION OR NULL), 2))) < 25)) THEN 1 ELSE 0 END)) AS "sum:Calculation_201676849087516673:ok",
  ...
  SUM((CASE WHEN (("Extract"."Is CP" = 1) AND (TABLEAU.SQRT((TABLEAU.POWER(CAST(("Extract"."EndXpass" - 60) AS DOUBLE PRECISION OR NULL), 2) + TABLEAU.POWER(CAST("Extract"."EndYPass" AS DOUBLE PRECISION OR NULL), 2))) < 15)) THEN 1 ELSE 0 END)) AS "sum:Deep Passes (copy):ok",
...
SELECT MIN(TABLEAU.NORMALIZE_DATETIME("Extract"."Timestamp")) AS "lower:none:Timestamp:qk",
  MAX(TABLEAU.NORMALIZE_DATETIME("Extract"."Timestamp")) AS "upper:none:Timestamp:qk"
FROM "Extract"."Extract" "Extract"
...
FROM (
  SELECT (CAST(SUM("Extract"."Minutes") AS DOUBLE PRECISION OR NULL) / NULLIF(90,0)) AS "usr:Calculation_2211120183238996:qk"
  FROM "Extract"."Extract" "Extract"
  WHERE ((TABLEAU.NORMALIZE_DATETIME("Extract"."Timestamp") >= '1899-12-30 00:00:00.000'::timestamp) AND (TABLEAU.NORMALIZE_DATETIME("Extract"."Timestamp") <= '1899-12-30 01:27:02.000'::timestamp))
  GROUP BY "Extract"."PlayerID="
) "t0"
...
FROM (
  ...
  FROM (
    SELECT "Extract"."PlayerID=" AS "PlayerID=",
      ...
      ((MEDIAN((CASE WHEN ("Extract"."EventID=" IN (3, 6, 11, 12, 13, 15, 16, 17, 18, 19, 29, 32, 33, 34, 35, 36, 37, 38)) THEN "Extract"."X=" ELSE null::int END)) < -11) AND (MEDIAN((CASE WHEN ("Extract"."EventID=" IN (3, 6, 11, 12, 13, 15, 16, 17, 18, 19, 29, 32, 33, 34, 35, 36, 37, 38)) THEN "Extract"."X=" ELSE null::int END)) > -40) AND (MEDIAN((CASE WHEN ("Extract"."EventID=" IN (3, 6, 11, 12, 13, 15, 16, 17, 18, 19, 29, 32, 33, 34, 35, 36, 37, 38)) THEN ABS("Extract"."Y=") ELSE null::int END)) < 25)) AS "$temp1_cse",
      ((MEDIAN((CASE WHEN ("Extract"."EventID=" IN (3, 6, 11, 12, 13, 15, 16, 17, 18, 19, 29, 32, 33, 34, 35, 36, 37, 38)) THEN ABS("Extract"."Y=") ELSE null::int END)) > 24) AND (MEDIAN((CASE WHEN ("Extract"."EventID=" IN (3, 6, 11, 12, 13, 15, 16, 17, 18, 19, 29, 32, 33, 34, 35, 36, 37, 38)) THEN "Extract"."X=" ELSE null::int END)) < 7)) AS "$temp2_cse",
      ((MEDIAN((CASE WHEN ("Extract"."EventID=" IN (3, 6, 11, 12, 13, 15, 16, 17, 18, 19, 29, 32, 33, 34, 35, 36, 37, 38)) THEN "Extract"."X=" ELSE null::int END)) > -12) AND (MEDIAN((CASE WHEN ("Extract"."EventID=" IN (3, 6, 11, 12, 13, 15, 16, 17, 18, 19, 29, 32, 33, 34, 35, 36, 37, 38)) THEN "Extract"."X=" ELSE null::int END)) < 0) AND (MEDIAN((CASE WHEN ("Extract"."EventID=" IN (3, 6, 11, 12, 13, 15, 16, 17, 18, 19, 29, 32, 33, 34, 35, 36, 37, 38)) THEN ABS("Extract"."Y=") ELSE null::int END)) < 25)) AS "$temp3_cse",
      ((MEDIAN((CASE WHEN ("Extract"."EventID=" IN (3, 6, 11, 12, 13, 15, 16, 17, 18, 19, 29, 32, 33, 34, 35, 36, 37, 38)) THEN ABS("Extract"."Y=") ELSE null::int END)) < 25) AND (MEDIAN((CASE WHEN ("Extract"."EventID=" IN (3, 6, 11, 12, 13, 15, 16, 17, 18, 19, 29, 32, 33, 34, 35, 36, 37, 38)) THEN "Extract"."X=" ELSE null::int END)) > -1) AND (MEDIAN((CASE WHEN ("Extract"."EventID=" IN (3, 6, 11, 12, 13, 15, 16, 17, 18, 19, 29, 32, 33, 34, 35, 36, 37, 38)) THEN "Extract"."X=" ELSE null::int END)) < 6)) AS "$temp4_cse",
      ((MEDIAN((CASE WHEN ("Extract"."EventID=" IN (3, 6, 11, 12, 13, 15, 16, 17, 18, 19, 29, 32, 33, 34, 35, 36, 37, 38)) THEN "Extract"."X=" ELSE null::int END)) > 14) AND (MEDIAN((CASE WHEN ("Extract"."EventID=" IN (3, 6, 11, 12, 13, 15, 16, 17, 18, 19, 29, 32, 33, 34, 35, 36, 37, 38)) THEN ABS("Extract"."Y=") ELSE null::int END)) < 23)) AS "$temp5_cse",
      ((MEDIAN((CASE WHEN ("Extract"."EventID=" IN (3, 6, 11, 12, 13, 15, 16, 17, 18, 19, 29, 32, 33, 34, 35, 36, 37, 38)) THEN "Extract"."X=" ELSE null::int END)) >= 6) AND (MEDIAN((CASE WHEN ("Extract"."EventID=" IN (3, 6, 11, 12, 13, 15, 16, 17, 18, 19, 29, 32, 33, 34, 35, 36, 37, 38)) THEN ABS("Extract"."Y=") ELSE null::int END)) < 23)) AS "$temp6_cse",
      ((MEDIAN((CASE WHEN ("Extract"."EventID=" IN (3, 6, 11, 12, 13, 15, 16, 17, 18, 19, 29, 32, 33, 34, 35, 36, 37, 38)) THEN ABS("Extract"."Y=") ELSE null::int END)) > 22) AND (MEDIAN((CASE WHEN ("Extract"."EventID=" IN (3, 6, 11, 12, 13, 15, 16, 17, 18, 19, 29, 32, 33, 34, 35, 36, 37, 38)) THEN "Extract"."X=" ELSE null::int END)) > 6)) AS "$temp7_cse"
    FROM "Extract"."Extract" "Extract"
    GROUP BY 1
...
SELECT "t1"."PlayerID=" AS "PlayerID=",
  ...
  MEDIAN((CASE WHEN "t1"."$temp3_cse" THEN ABS("t1"."Y=") ELSE null::int END)) AS "TEMP(Median X for Position (copy))(4165715327)(0)",
...
SELECT "t1"."Date" AS "Date",
  ...
  SUM((CASE ("t1"."EventID=" = 27) WHEN TRUE THEN "t1"."xA" WHEN FALSE THEN 0 ELSE NULL END)) AS "TEMP(Calculation_9851124000635091)(1801517227)(0)",
  SUM((CASE ("t1"."EventID=" = 26) WHEN TRUE THEN "t1"."xA" WHEN FALSE THEN 0 ELSE NULL END)) AS "TEMP(Corners xA (copy))(2964885437)(0)",
  MEDIAN((CASE WHEN "t1"."$temp1_cse" THEN ABS("t1"."Y=") ELSE null::int END)) AS "TEMP(Median X for Position (copy))(4165715327)(0)",
...
SELECT "t2"."PlayerID=" AS "PlayerID=",
  ...
  MEDIAN((CASE WHEN "t2"."$temp42_cse" THEN ABS("t2"."Y=") ELSE null::int END)) AS "TEMP(Median X for Position (copy))(4165715327)(0)",
  ...
  SUM(TABLEAU.SQRT((TABLEAU.POWER(CAST(((-"t2"."X=") - 60) AS DOUBLE PRECISION OR NULL), 2) + TABLEAU.POWER(CAST("t2"."Y=" AS DOUBLE PRECISION OR NULL), 2)))) AS "sum:Calculation_925349021690986496:ok",
  ...
  SUM(TABLEAU.SQRT((TABLEAU.POWER(CAST(("t2"."X=" - 60) AS DOUBLE PRECISION OR NULL), 2) + TABLEAU.POWER(CAST("t2"."Y=" AS DOUBLE PRECISION OR NULL), 2)))) AS "sum:Distance to Own Goal (copy):ok",
  ...
  MEDIAN((CASE WHEN "t2"."$temp42_cse" THEN "t2"."X=" ELSE null::int END)) AS "usr:Calculation_2284169459392434182:ok",
  ...
  MEDIAN((CASE WHEN "t2"."$temp42_cse" THEN ABS("t2"."Y=") ELSE null::int END)) AS "usr:Median X for Position (copy):ok",
  ...
  FROM (
    ...
    FROM (
      SELECT "Extract"."xG" AS "xG",
        ...
        TABLEAU.SQRT((TABLEAU.POWER(CAST(("Extract"."EndXpass" - 60) AS DOUBLE PRECISION OR NULL), 2) + TABLEAU.POWER(CAST("Extract"."EndYPass" AS DOUBLE PRECISION OR NULL), 2))) AS "$temp30_cse",
...
SELECT MIN(TABLEAU.SQRT((TABLEAU.POWER(CAST(((-"Extract"."X=") - 60) AS DOUBLE PRECISION OR NULL), 2) + TABLEAU.POWER(CAST("Extract"."Y=" AS DOUBLE PRECISION OR NULL), 2)))) AS "lower:none:Calculation_925349021690986496:qk",
  MAX(TABLEAU.SQRT((TABLEAU.POWER(CAST(((-"Extract"."X=") - 60) AS DOUBLE PRECISION OR NULL), 2) + TABLEAU.POWER(CAST("Extract"."Y=" AS DOUBLE PRECISION OR NULL), 2)))) AS "upper:none:Calculation_925349021690986496:qk"
FROM "Extract"."Extract" "Extract"
...
FROM (
  SELECT SUM((CASE WHEN ("Extract"."EventID=" = 16) THEN 1 ELSE 0 END)) AS "sum:Calculation_2976949761672400900:qk",
    ...
    (CAST(SUM("Extract"."Minutes") AS DOUBLE PRECISION OR NULL) / NULLIF(90,0)) AS "usr:Calculation_2211120183238996:qk"
  FROM "Extract"."Extract" "Extract"
  WHERE ((TABLEAU.SQRT((TABLEAU.POWER(CAST(((-"Extract"."X=") - 60) AS DOUBLE PRECISION OR NULL), 2) + TABLEAU.POWER(CAST("Extract"."Y=" AS DOUBLE PRECISION OR NULL), 2))) >= '0'::double precision) AND (TABLEAU.SQRT((TABLEAU.POWER(CAST(((-"Extract"."X=") - 60) AS DOUBLE PRECISION OR NULL), 2) + TABLEAU.POWER(CAST("Extract"."Y=" AS DOUBLE PRECISION OR NULL), 2))) <= '126.81088281373961'::double precision))
  GROUP BY "Extract"."PlayerID="
) "t0"
...
SELECT "Extract"."PlayerID=" AS "PlayerID=",
  ...
  MIN("Extract"."PlayerName") AS "TEMP(attr:PlayerName:nk)(1770644245)(0)",
  MAX("Extract"."PlayerName") AS "TEMP(attr:PlayerName:nk)(2018006382)(0)",
  MEDIAN(ABS("Extract"."Y=")) AS "med:Calculation_4291120182805309:ok",
  MEDIAN("Extract"."X=") AS "med:X=:ok",
  MEDIAN((CASE WHEN ("Extract"."EventID=" IN (3, 6, 11, 12, 13, 15, 16, 17, 18, 19, 29, 32, 33, 34, 35, 36, 37, 38)) THEN "Extract"."X=" ELSE null::int END)) AS "usr:Calculation_2284169459392434182:ok"
FROM "Extract"."Extract" "Extract"
WHERE (CASE WHEN (("Extract"."EventEn=" IN ('BadBehavior', 'Corner Crossed', 'Corner Passed', 'Foul', 'FreeKick', 'Offside', 'OneONOne', 'Shoot', 'Substitution')) OR ("Extract"."EventEn=" IS NULL)) THEN FALSE ELSE TRUE END)
GROUP BY 1
...
FROM (
  ...
  FROM "Extract"."Extract" "Extract"
  GROUP BY "Extract"."PlayerID=",
    TABLEAU.TO_DATETIME(DATE_TRUNC('DAY', TABLEAU.NORMALIZE_DATETIME("Extract"."Date")), "Extract"."Date")
) "t0"
...
SELECT "Extract"."PlayerID=" AS "PlayerID=",
  ...
  SUM((((CASE WHEN (("Extract"."EventID=" = 17) AND ("Extract"."ResultID=" = 10) AND ("Extract"."IsKPNA" = 1)) THEN 1 ELSE 0 END) + (CASE WHEN (("Extract"."EventID=" = 29) AND ("Extract"."ResultID=" = 10) AND ("Extract"."IsKPNA" = 1)) THEN 1 ELSE 0 END)) + (CASE WHEN (("Extract"."EventID=" = 15) AND ("Extract"."ResultID=" = 10) AND ("Extract"."IsKPNA" = 1)) THEN 1 ELSE 0 END))) AS "sum:Calculation_7871123234319930:ok",
  TABLEAU.TO_DATETIME(DATE_TRUNC('DAY', TABLEAU.NORMALIZE_DATETIME("Extract"."Date")), "Extract"."Date") AS "tdy:Date:ok"
FROM "Extract"."Extract" "Extract"
GROUP BY 1,
  18
